USE [master]
    GO
/****** Object:  Database [Brewing]    Script Date: 6/14/2022 7:43:04 PM ******/
...
USE [Brewing]
    GO
/****** Object:  Table [dbo].[Attempts]    Script Date: 6/14/2022 7:43:04 PM ******/
SET ANSI_NULLS ON
    GO
...
[Id] ASC
    ...
    GO
/****** Object:  Table [dbo].[LeaderboardPoints]    Script Date: 6/14/2022 7:43:04 PM ******/
SET ANSI_NULLS ON
    GO
SET QUOTED_IDENTIFIER ON
    GO
CREATE TABLE [dbo].[LeaderboardPoints](
    ...
    GO
/****** Object:  Table [dbo].[LeaderboardTime]    Script Date: 6/14/2022 7:43:04 PM ******/
SET ANSI_NULLS ON
    GO
SET QUOTED_IDENTIFIER ON
    GO
CREATE TABLE [dbo].[LeaderboardTime](
    ...
    GO
/****** Object:  Table [dbo].[Users]    Script Date: 6/14/2022 7:43:04 PM ******/
SET ANSI_NULLS ON
    GO
SET QUOTED_IDENTIFIER ON
    GO
...
ALTER TABLE [dbo].[LeaderboardTime] CHECK CONSTRAINT [FK_LeaderboardTime_UserId_Users_Id]
    GO
ALTER TABLE [dbo].[Attempts]  WITH CHECK ADD  CONSTRAINT [CHK_Points] CHECK  (([Points]>(0)))
    GO
ALTER TABLE [dbo].[Attempts] CHECK CONSTRAINT [CHK_Points]
    GO
